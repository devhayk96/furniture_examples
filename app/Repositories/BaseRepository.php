...
//        $this->fields = SchemaHelper::getTableColumns($this->getModel());
    ...
    public function all(): self
    {
        ...
        //@todo пока закомменчено, потому что ломаает реляционные выборки в ресурс-коллекциях
...
//
//            $this->setSelect(array_filter(
//                $fields,
//                function ($field) {
//                    return in_array($field, SchemaHelper::getTableColumns($this->getModel()));
//                }
//            ));
//        }
